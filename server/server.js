...
app.get("/getOffers/:filter", async (req, res) => {
  const customOffers = await database.query(
    "SELECT * from offer WHERE :filter = $1",
    [req.params.filterOption]
  );
  ...
  try {
    const result = await database.query(
      ...
      [
        ...
        req.body.offer_location,
        req.body.quantity,
        req.body.waste_source,
        req.body.waste_type,
        req.body.waste_structure,
        req.body.waste_colour,
